...
<body>
    ...
    <div id="contenido">
        ...
        <aside>
            ...
            <br><br>
            <figure>
                <a href="NuestrosProductos.php"><img src="../../../PrimeraWeb/Vista/img/monitor1.webp" alt="Monitor en oferta"></a>
                <figcaption>Monitor PC 60,4 cm (23,8") LG 24MR400-B, 100 Hz, IPS Full HD</figcaption>
            </figure>
            <br><br><br><br>
            <figure>
                <a href="NuestrosProductos.php"><img src="../../../PrimeraWeb/Vista/img/ratonErgonomico.jpg" alt="Ratón ergonómico"></a>
                <figcaption>Trust Verto Ratón Vertical, Ratón Ergonómico con Cable USB 1000/1600 dpi</figcaption>
            </figure>
            <br><br><br><br>
            <figure>
                <a href="NuestrosProductos.php"><img src="../../../PrimeraWeb/Vista/img/ps3.webp" alt="Play Station 3 Slim"></a>
